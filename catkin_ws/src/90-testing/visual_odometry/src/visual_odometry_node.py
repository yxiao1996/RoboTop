...
from robocon_msgs.msg import viz_odom_rot, viz_odom_tran
...
class VisualOdometsy():
    def __init__(self):
        ...
        self.pub_debug_rot = rospy.Publisher("~debug_rot", Float32MultiArray)
        self.pub_debug_tran = rospy.Publisher("~debug_tran", Float32MultiArray)
        # Subscribers
