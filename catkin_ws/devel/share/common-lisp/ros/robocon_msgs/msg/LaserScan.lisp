...
(cl:defmethod cl:initialize-instance :after ((m <LaserScan>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LaserScan)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robocon_msgs-msg:<LaserScan> is deprecated: use robocon_msgs-msg:LaserScan instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <LaserScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robocon_msgs-msg:header-val is deprecated.  Use robocon_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'seq-val :lambda-list '(m))
(cl:defmethod seq-val ((m <LaserScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robocon_msgs-msg:seq-val is deprecated.  Use robocon_msgs-msg:seq instead.")
  (seq m))

(cl:ensure-generic-function 'stamp-val :lambda-list '(m))
(cl:defmethod stamp-val ((m <LaserScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robocon_msgs-msg:stamp-val is deprecated.  Use robocon_msgs-msg:stamp instead.")
  (stamp m))

(cl:ensure-generic-function 'frame_id-val :lambda-list '(m))
(cl:defmethod frame_id-val ((m <LaserScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robocon_msgs-msg:frame_id-val is deprecated.  Use robocon_msgs-msg:frame_id instead.")
  (frame_id m))

(cl:ensure-generic-function 'angle_min-val :lambda-list '(m))
(cl:defmethod angle_min-val ((m <LaserScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robocon_msgs-msg:angle_min-val is deprecated.  Use robocon_msgs-msg:angle_min instead.")
  (angle_min m))

(cl:ensure-generic-function 'angle_max-val :lambda-list '(m))
(cl:defmethod angle_max-val ((m <LaserScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robocon_msgs-msg:angle_max-val is deprecated.  Use robocon_msgs-msg:angle_max instead.")
  (angle_max m))

(cl:ensure-generic-function 'angle_increment-val :lambda-list '(m))
(cl:defmethod angle_increment-val ((m <LaserScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robocon_msgs-msg:angle_increment-val is deprecated.  Use robocon_msgs-msg:angle_increment instead.")
  (angle_increment m))

(cl:ensure-generic-function 'time_increment-val :lambda-list '(m))
(cl:defmethod time_increment-val ((m <LaserScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robocon_msgs-msg:time_increment-val is deprecated.  Use robocon_msgs-msg:time_increment instead.")
  (time_increment m))

(cl:ensure-generic-function 'scan_time-val :lambda-list '(m))
(cl:defmethod scan_time-val ((m <LaserScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robocon_msgs-msg:scan_time-val is deprecated.  Use robocon_msgs-msg:scan_time instead.")
  (scan_time m))

(cl:ensure-generic-function 'range_min-val :lambda-list '(m))
(cl:defmethod range_min-val ((m <LaserScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robocon_msgs-msg:range_min-val is deprecated.  Use robocon_msgs-msg:range_min instead.")
  (range_min m))

(cl:ensure-generic-function 'range_max-val :lambda-list '(m))
(cl:defmethod range_max-val ((m <LaserScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robocon_msgs-msg:range_max-val is deprecated.  Use robocon_msgs-msg:range_max instead.")
  (range_max m))

(cl:ensure-generic-function 'ranges-val :lambda-list '(m))
(cl:defmethod ranges-val ((m <LaserScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robocon_msgs-msg:ranges-val is deprecated.  Use robocon_msgs-msg:ranges instead.")
  (ranges m))

(cl:ensure-generic-function 'intensities-val :lambda-list '(m))
(cl:defmethod intensities-val ((m <LaserScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robocon_msgs-msg:intensities-val is deprecated.  Use robocon_msgs-msg:intensities instead.")
  (intensities m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LaserScan>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%  uint32 seq~%  time stamp~%  string frame_id~%float32 angle_min~%float32 angle_max~%float32 angle_increment~%float32 time_increment~%float32 scan_time~%float32 range_min~%float32 range_max~%float32[] ranges~%float32[] intensities~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LaserScan)))
  "Returns full string definition for message of type 'LaserScan"
  (cl:format cl:nil "std_msgs/Header header~%  uint32 seq~%  time stamp~%  string frame_id~%float32 angle_min~%float32 angle_max~%float32 angle_increment~%float32 time_increment~%float32 scan_time~%float32 range_min~%float32 range_max~%float32[] ranges~%float32[] intensities~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
